package com.zyao89.view.zloadingL.rect;
...
import com.zyao89.view.zloadingL.base.BaseStateBuilder;
...
public class ChartRectBuilder extends BaseStateBuilder
{
    ...
    {
        mAnimateDurationTime = ZLoadingBuilder.ceil(getAnimationDuration() * 0.4);
        // 动画间隔
